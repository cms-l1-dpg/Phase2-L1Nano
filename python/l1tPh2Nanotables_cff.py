...
gttEtSumTable = cms.EDProducer(
    "SimpleL1EtSumFlatTableProducer",
...
gttHtSumTable = gttEtSumTable.clone(
...
gmtTkMuTable = cms.EDProducer(
    #"SimpleCandidateFlatTableProducer",
    "L1TrackerMuonFlatTableProducer",
...
sc4JetTable = cms.EDProducer(
    # "SimpleL1PFJetFlatTableProducer",
    "SimpleCandidateFlatTableProducer",
...
nnPuppiTauTable = cms.EDProducer(
    "SimpleL1PFTauFlatTableProducer",
